...
const KeyManagement = () => {
  ...
  const styles = {
    ...
    actionButton: (variant) => {
      const variants = {
        primary: { bg: 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)', hover: '0 6px 20px rgba(99, 102, 241, 0.4)' },
        success: { bg: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', hover: '0 6px 20px rgba(16, 185, 129, 0.4)' },
        warning: { bg: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', hover: '0 6px 20px rgba(245, 158, 11, 0.4)' },
        danger: { bg: 'linear-gradient(135deg, #ef4444 0%, #dc2626 100%)', hover: '0 6px 20px rgba(239, 68, 68, 0.4)' }
      };
  ...
  return (
    <div className="wrapper" style={styles.pageWrapper}>
      <Sidebar />
      <div className="content-page" style={{background: 'transparent'}}>
        ...
        <div className="container-fluid px-3 px-md-4">
          ...
          <div className="container-fluid">
            <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
              <div>
                <h2 style={{fontSize: '1.75rem', fontWeight: '700', margin: 0, marginBottom: '8px', color:'white'}}>
                  <i className="ri-key-2-line me-2"></i>
                  Quản lý License Key
                </h2>
                <p style={{margin: 0, opacity: 0.9, fontSize: '0.95rem', color:'white'}}>
                  ...
                  <table style={{width: '100%', borderCollapse: 'collapse'}}>
                    ...
                    <tbody>
                      {currentKeys.map((key, index) => (
                        <tr key={key.key_value} style={{borderBottom: '1px solid #f1f5f9', transition: 'background 0.2s'}}
                        ...
                        >
                          <td style={{padding: '16px 20px'}}>
                            <div style={{display: 'flex', alignItems: 'center', gap: '12px'}}>
                              <div style={{flex: 1}}>
                                <code style={{fontSize: '0.875rem', color: '#6366f1', fontWeight: '600', display: 'block', marginBottom: '4px'}}>
                                  {key.key_value}
                                </code>
                                {key.note && (
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: '8px',
                            cursor: 'pointer',
                            color: currentPage === pageNumber ? '#fff' : '#475569',
                            fontWeight: '600',
                            fontSize: '0.875rem',
                            boxShadow: currentPage === pageNumber ? '0 4px 12px rgba(99, 102, 241, 0.3)' : 'none'
                          }}
        ...
        <div style={styles.modal} onClick={() => setShowCreateModal(false)}>
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            <div style={{padding: '32px 32px 24px', borderBottom: '1px solid #f1f5f9'}}>
              <h3 style={{fontSize: '1.5rem', fontWeight: '700', color: '#1e293b', margin: 0, display: 'flex', alignItems: 'center', gap: '12px'}}>
                <i className="ri-add-circle-line" style={{color: '#6366f1'}}></i>
                Tạo License Key mới
              </h3>
            </div>
      ...
      {showEditModal && selectedKey && (
        <div style={styles.modal} onClick={() => setShowEditModal(false)}>
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            <div style={{padding: '32px 32px 24px', borderBottom: '1px solid #f1f5f9'}}>
              <h3 style={{fontSize: '1.5rem', fontWeight: '700', color: '#1e293b', margin: 0, display: 'flex', alignItems: 'center', gap: '12px'}}>
                <i className="ri-edit-line" style={{color: '#6366f1'}}></i>
